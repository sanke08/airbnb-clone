        ...
        <div className={className}>
            ...
            <div className=' mt-2'>
                ...
                <div className=' border flex w-full justify-between rounded-2xl mt-2 overflow-hidden text-black'>
                    <Button onClick={() => handleChange("room")} variant={"none"} className={twMerge(' text-black w-full border rounded-none hover:bg-black/10', type === "room" && "bg-black text-white hover:bg-black")}>Room</Button>
                    <Button onClick={() => handleChange("home")} variant={"none"} className={twMerge(' text-black w-full border rounded-none hover:bg-black/10', type === "home" && "bg-black text-white hover:bg-black")}>Home</Button>
                </div>
            </div>
        </div>
    )
