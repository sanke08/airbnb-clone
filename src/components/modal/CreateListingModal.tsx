...
const CreateListingModal = () => {
    ...
    return (
        <Modal close={handleClose} open={openListin} header='Create Listing' description='rent your hotel'>
            <div className={twMerge(' flex relative transition-all duration-500', step === 1 && "h-[28rem]", step === 2 && "h-[18rem]", step === 3 && "h-[20rem]", step === 4 && "h-[28rem]", step === 5 && "h-[10rem]", step === 6 && "h-[20em]")}>
